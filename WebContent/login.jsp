							...
							<ul class="mobile-menu-nav">
								<li><a data-toggle="collapse" data-target="#Charts"
									...
									<ul class="collapse dropdown-header-top" style="display: none;">
										...
										<li><a href="existingsystem.jsp" style="display: none;">Existing System</a></li>
										<li><a href="proposedsystem.jsp" style="display: none;">Proposed System</a></li>
								...
								<li><a data-toggle="collapse" data-target="#demoevent"
									...
									<ul id="demoevent" class="collapse dropdown-header-top">
										...
										<li><a href="forgotpassword.jsp" style="display: none;">Forgot Password</a></li>
									</ul></li>
							</ul>
						</nav>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="tab-content custom-menu-content">
						<div id="Home"
							...
							<!-- <ul class="notika-main-menu-dropdown" style="display: none;">
								<li><a href="index.jsp" style="display: none;">About</a></li>
								<li><a href="existingsystem.jsp" style="display: none;">Existing System</a></li>
								<li><a href="proposedsystem.jsp">Proposed System</a></li>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="footer-copy-right">
						<p>Copyright © 2019 <%=Constants.PROJECT_NAME%> by <%=Constants.COMPANY_NAME %></p>
					</div>
				</div>
			</div>
		</div>
