...
public class Vader {
    ...
    public VScore analyseSentence( List<Token> sentence ) {
        if ( sentence != null ) {
            ...
            for ( Token item : snt ) {
            	...
            	System.out.println("Token : "+item.getValue());
                double v = 0.0;
    ...
    public void init() throws IOException {
    	...
    	System.out.println("Vader: init lexicon(vader_sentiment_lexicon.txt)");
        moodSet = new HashMap<>();
            ...
            if (vaderLexicon.length() > 0) {
                for (String line : vaderLexicon.split("\n")) {
                    ...
                    if (items.length > 2) {
                    	...
                    	System.out.println("skipping invalid Vader line: " + line);
                    }
                }
            }
        }
        ...
        System.out.println("Vader: init idioms(vader_idioms.txt)");
